								...
								<div class="blog_post">
									<form
										...
										<div class="blog_details">
											...
											<div id="largo<%=i%>" class="text-comment">
												<span id="largo"><%=partidos.get(i).getInformacion()%></span>
											</div>
											<%
												String idSpan = "more" + i;
													String idDiv = "largo" + i;
											%>
											<span id="more<%=i%>" class="more"
												onclick="textoCompleto(<%=i%>)">Leer más...</span>
				...
				<div class="col-lg-4">
					<div class="blog_right_sidebar">
						...
						<aside class="single_sidebar_widget author_widget">
							<img class="author_img rounded-circle" src="img/blog/author1.jpg"
								alt="">
							<h4>Mónica Merino</h4>
							<p>Desarrolladora Java</p>
							<div class="social_icon">
								<a target="_blank" href="https://www.facebook.com/"><i
									...
									target="_blank" href=https://github.com /><i class="ti-github"></i></a>
								<a target="_blank" href="https://www.linkedin.com/feed/"><i
									class="ti-linkedin"></i></a>
							</div>
							<p>Como desarrolladora web Java tengo que destacar el gran
								trabajo de esta web. Como ciudadana, reconozco que es una buena
								idea. Antes no solía ir a votar, ahora ya no tengo escusa.</p>
							<div class="br"></div>
						</aside>
